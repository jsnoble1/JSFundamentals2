...
function merge (obj1, obj2){
  for(var key in obj1) { obj2[key] = obj2[key] || obj1[key];}
}
...
a one dimentional array.
 ...
 function flatten(arr){ ._flatten(arr)}
...
function map (arr){ _.map(arr, function(i){i.name = "Jared"; i.isAwesome = true;})}
...
var catNames = ["billy","cat","hannibal"];
...
to the CatMaker function. This will return an array of cat objects
   ...
   var catsnam =  _.map(catNames, CatMaker)
...
_.each(catsnam, function(i){i.speak();})
